                ...
                @foreach ($courses as $course)
                    <div class="col-md-4">
                        <div class="card h-100 shadow-sm">
                            ...
                            <img src="{{ asset('assets/compiled/sampul-course/' . $course['courseimg']) }}" class="card-img-top"
                                alt="{{ $course['coursetit'] }}">

                            <div class="card-body">
                                <h5 class="card-title">{{ $course['coursetit'] }}</h5>
                                <p class="card-text">{{ $course['coursedesc'] }}</p>
                                <a href="/courses/strategi-pemasaran" class="btn btn-outline-primary btn-sm">Lihat
                                    Kursus</a>
                            </div>
                        </div>
                    </div>
